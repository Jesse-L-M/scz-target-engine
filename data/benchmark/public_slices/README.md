...
- As of April 2, 2026, those slices are honest and replayable, but none are evaluable on the principal `3y` horizon after strict pre-cutoff denominator filtering.
...
Replay example for the checked-in `scz_translational_2024_06_20` slice:
